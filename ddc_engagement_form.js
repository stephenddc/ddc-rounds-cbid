...
const ER_RESOURCES = ['911', 'Non-emergency Police', 'Mental Health Professional', '311'];
...
function renderResolutionCycling() {
  ...
  document.getElementById('resolution-panel-footer').innerHTML =
    (resPanelState.current > 0
      ...
      : '<button class="btn-ghost-round" onclick="closeOverlayPanel(\'resolution-panel\')"><i class="ti ti-x"></i></button>') +
...
function openEmergencyResponsePanel() {
  ...
  document.getElementById('er-panel-title').textContent = 'Emergency response - NEW';
...
function renderErCycling() {
  ...
  body.innerHTML = '' +
    ...
    '<div class="card" id="er-card-resources"><div class="card-header"><span>Emergency resources contacted</span><p>Required - select all that apply</p></div>' + resourcesHtml +
  ...
  document.getElementById('er-panel-title').textContent = 'Emergency response - ' + (rec.types.length > 0 ? 'EDIT' : 'NEW');
  ...
  document.getElementById('er-panel-footer').innerHTML =
    (erPanelState.current > 0
      ...
      : '<button class="btn-ghost-round" onclick="closeOverlayPanel(\'er-panel\')"><i class="ti ti-x"></i></button>') +
